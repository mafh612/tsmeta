...
const initializerToString: (initializer: Expression) => string | number | boolean = (
  ...
  switch (initializer.kind) {
    case SyntaxKind.StringLiteral:
      return TokenToString(initializer as Identifier)
    ...
    case SyntaxKind.ObjectLiteralExpression:
      return ObjectLiteralExpressionToString(initializer as ObjectLiteralExpression)
    default:
      return TokenToString(initializer as Identifier)
  }
}

export { initializerToString as InitializerToString }
