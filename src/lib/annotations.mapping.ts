 ...
 */
const setAnnoationsMapping: (mapping: { [key: string]: string }) => void = (mapping: {
  [key: string]: string
}): void => {
  annoationsMapping = mapping
}

export { getMappedAnnotation as GetMappedAnnotation, setAnnoationsMapping as SetAnnoationsMapping }
